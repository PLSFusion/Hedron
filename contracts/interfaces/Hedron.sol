...
interface IHedron {
    ...
    function calcLoanPayment(uint256 hsiIndex, address hsiAddress)
        external
        view
        returns (uint256, uint256);

    function calcLoanPayoff(uint256 hsiIndex, address hsiAddress)
        external
        view
        returns (uint256, uint256);
    ...
    function claimNative(uint256 stakeIndex, uint40 stakeId) external;
    ...
    function loanInstanced(uint256 hsiIndex, address hsiAddress) external;
    ...
    function loanLiquidateExit(uint256 liquidationId) external;

    function loanPayment(uint256 hsiIndex, address hsiAddress) external;

    function loanPayoff(uint256 hsiIndex, address hsiAddress) external;

    function loanedSupply() external view returns (uint256);

    function mintInstanced(uint256 hsiIndex, address hsiAddress) external;

    function mintNative(uint256 stakeIndex, uint40 stakeId) external;
